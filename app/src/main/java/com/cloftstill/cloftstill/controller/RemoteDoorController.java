...
public class RemoteDoorController {
     ...
     * // TODO a ser removido.
     */
    public static ServerResponse requestOpenALT(Authenticable authenticable, String gpsPosition) {
     ...
     */
    public static String requestOpen(Authenticable authenticable, String gpsPosition) {
        String doorResponse = null;
        HttpRequestHandler handler = new HttpRequestHandler();
        ...
        try {
            ...
            String response = handler.executePOST(uri, jsonBody.toString());
            doorResponse = new JSONObject(response).getString("message");
